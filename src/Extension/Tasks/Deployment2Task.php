...
use SprykerSdk\Sdk\Extension\Tasks\Commands\Timeout2Command;
...
class Deployment2Task implements TaskInterface
{
    /**
     * @return string
     */
    ...
    {
        return 'ISO Compliance Snapshot';
    }
